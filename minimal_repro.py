...
def main():
    ...
    import_shape_tool = XCAFDoc_DocumentTool.ShapeTool_s(import_dm.doc.Main())
    ...
    print("(Session 29: now builds assembly structure NATIVELY,")
    print("recursing via extract_component_recursive())")
    print("=" * 70)
    uid = dm.add_component_from_label(import_shape_tool, wrapper_label, "nested_assembly")
