...
from OCP.BRep import BRep_Tool_Surface, BRep_Tool
...
from OCP.TopoDS import TopoDS_Vertex, TopoDS_Face, TopoDS_Edge
...
from OCP.gp import gp_Pnt2d, gp_Dir
...
class Face(TopoDS_Face, BaseObject):
    ...
    def domain(self):
        ...
        """
        return BRepTools.UVBounds_s(self)
    ...
    def is_trimmed(self):
        ...
        a = map(_round, BRepTools.UVBounds_s(self))
