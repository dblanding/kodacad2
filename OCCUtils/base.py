...
# init_display not needed in OCP
...
class GlobalProperties(object):
    ...
    def system(self):
        ...
        if _topo_type == "face" or _topo_type == "shell":
            BRepGProp.SurfaceProperties_s(self.instance, self._system)
        elif _topo_type == "edge":
            BRepGProp.LinearProperties_s(self.instance, self._system)
        elif _topo_type == "solid":
            BRepGProp.VolumeProperties_s(self.instance, self._system)
        return self._system
