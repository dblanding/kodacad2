...
from OCP.BRepOffsetAPI import BRepOffsetAPI_MakeEvolved
...
from OCP.TColgp import TColgp_SequenceOfVec, TColgp_HArray1OfPnt
from OCP.gp import (
    gp_Vec,
    gp_Pnt,
    gp_Dir,
...
def make_ruled(edgeA, edgeB):
    ...
    return BRepFill.Face_s(edgeA, edgeB)
...
def make_n_sections(edges):
    ...
    from OCP.BRepFill import BRepFill_NSections
...
def make_coons(edges):
    from OCP.GeomFill import GeomFill_BSplineCurves, GeomFill_StretchStyle
...
def make_constrained_surface_from_edges(edges):
    ...
    """
    from OCP.GeomPlate import GeomPlate_MakeApprox, GeomPlate_BuildPlateSurface
    from OCP.BRepFill import BRepFill_CurveConstraint
...
def fit_plane_through_face_vertices(_face):
    ...
    :return:        Geom_Plane
    """
    from OCP.GeomPlate import GeomPlate_BuildAveragePlane
...
def project_edge_onto_plane(edg, plane):
    ...
    """
    from OCP.GeomProjLib import geomprojlib_ProjectOnPlane
